...
internal object NdsAudio {
     ...
     *
     * @param buf The output buffer; must be at least [NdsAudio.WAV_HEADER_SIZE] bytes.
     ...
     * @param waveType       One of [NdsAudio.WAVE_PCM8], [NdsAudio.WAVE_PCM16], [NdsAudio.WAVE_ADPCM].
